...
define([
    ...
    'text!./SystemNetTransitionDecorator.DiagramDesignerWidget.html',
    'css!./SystemNetTransitionDecorator.DiagramDesignerWidget.css'
], function (CONSTANTS, nodePropertyNames, DiagramDesignerWidgetDecoratorBase, SystemNetTransitionDecoratorTemplate) {
    ...
    SystemNetTransitionDecorator = function (options) {
    ...
    SystemNetTransitionDecorator.prototype.$DOMBase = $(SystemNetTransitionDecoratorTemplate);

    SystemNetTransitionDecorator.prototype.on_addTo = function () {
        var self = this;
    ...
    SystemNetTransitionDecorator.prototype._renderName = function () {
    ...
    SystemNetTransitionDecorator.prototype.update = function () {
        var client = this._control._client,
            nodeObj = client.getNode(this._metaInfo[CONSTANTS.GME_ID]),
            newName = '';
    ...
    SystemNetTransitionDecorator.prototype.getConnectionAreas = function (id /*, isEnd, connectionMetaInfo*/) {
        var result = [],
            edge = 10,
            LEN = 20;
    ...
    SystemNetTransitionDecorator.prototype._onNodeTitleChanged = function (oldValue, newValue) {
        var client = this._control._client;
    ...
    SystemNetTransitionDecorator.prototype.doSearch = function (searchDesc) {
